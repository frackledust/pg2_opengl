...
int tutorial_8()
{
	...
	Texture3f image_albedo = Texture3f("../../../data/denoise/albedo_100sspp.exr"); // linear HDR image
	Texture3f image_normal = Texture3f("../../../data/denoise/normal_100spp.exr"); // linear HDR image

	void* albedoPtr = image_albedo.data();
	void* normalPtr = image_normal.data();
